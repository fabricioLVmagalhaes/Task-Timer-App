...
const val CONTENT_AUTHORITY = "com.magalhaes.tasktimer.provider"
...
class AppProvider : ContentProvider() {
    ...
    private fun buildUriMatcher(): UriMatcher {
        ...
        //e.g. content://com.magalhaes.tasktimer.provider/Tasks
        matcher.addURI(CONTENT_AUTHORITY, TasksContract.TABLE_NAME, TASKS)
        //e.g. content://com.magalhaes.tasktimer.provider/Tasks/8
